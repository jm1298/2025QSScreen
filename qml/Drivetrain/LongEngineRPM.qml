...
Rectangle {
    ...
    property alias longEngineRPM_timelineCurrentFrame: longEngineRPM_timeline.currentFrame
    ...
    Rectangle {
        ...
        Text {
            ...
            y: 0
            color: "#0b0b0b"
            text: longEngineRPM_timeline.currentFrame
            font.pixelSize: 20
