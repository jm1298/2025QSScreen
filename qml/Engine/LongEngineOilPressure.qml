...
Rectangle {
    ...
    property alias engineOilPressure_timelineCurrentFrame: engineOilPressure_timeline.currentFrame
    ...
    Rectangle {
        ...
        Text {
            ...
            y: 0
            color: "#0b0b0b"
            text: engineOilPressure_timeline.currentFrame
            font.pixelSize: 20
