...
Rectangle {
    ...
    property alias longEngineTemp_timelineCurrentFrame: longEngineTemp_timeline.currentFrame
    ...
    Rectangle {
        ...
        Text {
            ...
            y: 0
            color: "#0b0b0b"
            text: longEngineTemp_timeline.currentFrame
            font.pixelSize: 20
