...
Rectangle {
    ...
    property alias controlCurrentTimelineCurrentFrame: controlCurrentTimeline.currentFrame

    Text {
        id: title
        y: 0
        color: "#0b0b0b"
        text: qsTr("Control Current")
        font.pixelSize: 20
    ...
    Rectangle {
        ...
        Text {
            ...
            y: 0
            color: "#0b0b0b"
            text: controlCurrentTimeline.currentFrame
            font.pixelSize: 20
